...
//
//	mockgen -source=internal/libvirt/network/interface.go -destination=./test/mocks/libvirt/interface.go -package=mocks_libvirt
//

// Package mocks_libvirt is a generated GoMock package.
package mocks_libvirt
