...
// Source: internal/libvirt/domain/interface.go
//
// Generated by this command:
//
//	mockgen -source=internal/libvirt/domain/interface.go -destination=./test/mocks/libvirt/domain/interface.go -package=mocks_domain
//
...
func (m *MockManager) ForceStop(ctx context.Context, name string) error {
	m.ctrl.T.Helper()
...
func (mr *MockManagerMockRecorder) ForceStop(ctx, name any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ForceStop", reflect.TypeOf((*MockManager)(nil).ForceStop), ctx, name)
}
...
// BuildDomainXML mocks base method.
func (m *MockXMLBuilder) BuildDomainXML(params vm.VMParams) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BuildDomainXML", params)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// BuildDomainXML indicates an expected call of BuildDomainXML.
func (mr *MockXMLBuilderMockRecorder) BuildDomainXML(params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BuildDomainXML", reflect.TypeOf((*MockXMLBuilder)(nil).BuildDomainXML), params)
}
